<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="158px">
      ...
      <el-form-item label="是否推荐0不显示1显示" prop="categoryIsShow">
        <el-select v-model="queryParams.categoryIsShow" placeholder="请输入是否推荐0不显示1显示" clearable size="small">
         <el-option
    ...
    <!-- <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:kind:export']"
        >导出</el-button>
      </el-col>
	  <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row> -->

    <el-table v-loading="loading" :data="kindList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="商品分类表ID" align="center" prop="id" />
      <el-table-column label="父id" align="center" prop="categoryPid" />
      <el-table-column label="分类名称" align="center" prop="categoryCateName" />
      <el-table-column label="排序" align="center" prop="categorySort" />
      <el-table-column label="图标" align="center" prop="categoryPic" />
      <el-table-column label="是否推荐0不显示1显示" align="center" prop="categoryIsShow" :formatter="postCategoryStatus" />
      <el-table-column label="添加时间" align="center" prop="addTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.addTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="添加时间" align="center" prop="categoryHoverPic" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="父id" prop="categoryPid">
          <el-input v-model="form.categoryPid" placeholder="请输入父id" />
        </el-form-item>
        <el-form-item label="分类名称" prop="categoryCateName">
          <el-input v-model="form.categoryCateName" placeholder="请输入分类名称" />
        </el-form-item>
        <el-form-item label="排序" prop="categorySort">
          <el-input v-model="form.categorySort" placeholder="请输入排序" />
        </el-form-item>
        <el-form-item label="图标" prop="categoryPic">
          <el-input v-model="form.categoryPic" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="是否推荐0不显示1显示" prop="categoryIsShow">
          <el-input v-model="form.categoryIsShow" placeholder="请输入是否推荐0不显示1显示" />
        </el-form-item>
        <el-form-item label="添加时间" prop="addTime">
          <el-date-picker clearable size="small" style="width: 200px"
...
<script>
import { listKind, getKind, delKind, addKind, updateKind, exportKind } from "@/api/system/kind";
