  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="180px">
        ...
        <el-form-item label="社区文章id" prop="communityId">
          <el-input v-model="form.communityId" placeholder="请输入社区文章id" />
        </el-form-item>
        <el-form-item label="评论内容" prop="comment">
        ...
        <el-form-item label="评论时间" prop="commentCre">
          <el-date-picker clearable size="small" style="width: 200px"
            v-model="form.commentCre"
            type="date"
            value-format="yyyy-MM-dd"
            placeholder="选择评论时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="评论状态0待审核1通过2拒绝">
...
<script>
import { listComment, getComment, delComment, addComment, updateComment, exportComment,sysAuditFun,sysAuditDelFun } from "@/api/system/comment";
...
export default {
  ...
  methods: {
    ...
    commentsStatus(row, column) {
      // console.log(row)
      return this.selectDictLabel(this.commentOptions, row.commentStatus);
    },
     sysAudit(type){
