  ...
  <div class="app-container">
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="州/省" prop="stateName">
          <el-input v-model="form.stateName" placeholder="请输入州/省名称" />
        </el-form-item>
...
import {
  ...
  add,
  update,
} from "@/api/system/supportCenter/warranty/state";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        stateName: [
          { required: true, message: "请输入州/省名称", trigger: "change" },
        ],
      },
    };
  },
