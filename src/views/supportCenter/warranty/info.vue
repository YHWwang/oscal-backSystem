  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="70px">
      <el-form-item label="日期范围" prop="addTime" class="date-item">
        <el-date-picker type="daterange" v-model="queryParams.creTime" format="yyyy-MM-dd"
      ...
      <el-form-item>
        ...
        <el-button type="success" size="mini" @click="handleQuery">搜索</el-button>
    ...
    <el-table v-loading="loading" :data="dataList">
      ...
      <el-table-column label="内容" align="center" show-overflow-tooltip prop="issueDetails"/>
...
import {
  getLists
} from "@/api/system/supportCenter/warranty/warranty";
...
export default {
  ...
  methods: {
    ...
    CustomDate(date) { /*自定义时间 7天or30天*/
      ...
      this.queryParams.creTime = [this.date_count(date), this.date_count(0)]
      this.$nextTick(() => {
        this.getList();
      })
    },
